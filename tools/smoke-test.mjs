...
await page.reload();await page.waitForSelector('canvas');await page.waitForFunction(()=>window.__miner?.scene.getScene('mine')?.players?.length>0);assert.equal(await page.locator('#best').textContent(),'$1,250');
