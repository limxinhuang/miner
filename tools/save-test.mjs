...
try{
  ...
  await page.reload();await page.waitForSelector('canvas');assert.equal(await page.locator('#resume').isVisible(),true);
  ...
  await page.reload();await page.waitForSelector('canvas');await page.locator('#resume').click();await run(()=>window.__miner.loop.sleep());
  ...
  await page.reload();await page.waitForSelector('canvas');assert.equal(await page.locator('#resume').isHidden(),true);
  ...
  await page.reload();await page.waitForSelector('canvas');await page.locator('#action').click();
